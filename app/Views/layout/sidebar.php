...
<div class=" flex flex-col gap-6 mt-20">
    ...
    <div class="font-bold flex px-8 text-gray-700">General</div>
        ...
        <div class="flex items-center px-6 py-4 rounded-full transition bg-[#D5F8E5] hover:bg-gray-300 w-60 ml-6 cursor-pointer" onClick="window.location.href='dashboard'">
            <img src="/icon/dashboard.svg" alt="x">
            <div class="text-xl ml-5 text-black">Dashboard</div>
        </div>
   
    
        <div class="flex items-center px-6 py-4 rounded-full transition bg-[#D5F8E5] hover:bg-gray-300 w-60 ml-6 cursor-pointer" onClick="window.location.href='restock'">
            <img src="/icon/restock.svg" alt="x" >  
            <div class="text-xl ml-5 text-black">Iventory</div>
        </div>
    
    
        <div class="flex items-center px-6 py-4 rounded-full transition bg-[#D5F8E5] hover:bg-gray-300 w-60 ml-6 cursor-pointer" onClick="window.location.href='historyRestock'">
            <img src="/icon/historyRestock.svg" alt="x">
            <div class="text-xl ml-5 text-black">Restock</div>
        </div>
    
        <div class="flex items-center px-6 py-4 rounded-full transition bg-[#D5F8E5] hover:bg-gray-300 w-60 ml-6 cursor-pointer" onClick="window.location.href='historyPurchase'">
        ...
        <div class="mt-64">
            <div class=" my-auto flex items-center px-6 py-4 rounded-full transition bg-red-600 hover:bg-red-800 w-60 ml-6 cursor-pointer" onClick="window.location.href='logout'">
