...
<img src="background.svg" class= "bg-cover mr-20 absolute inset-0 -z-10"></img>
    ...
    <div class = "mx-12 my-28">
        ...
        <div class="flex flex-col gap-4 text-center lg:text-left">
            <h2 class="font-bold text-4xl lg:text-7xl">Welcome to</h2>
            <h2 class="font-bold text-[#EF9500] text-4xl lg:text-7xl">
                RAN Supermarket
            </h2>
            <h3 class="text-slate-500 text-lg lg:text-3xl">
                Stay Buy, Keep Wasting!
            </h3>
        </div>
